\chapter{Tutorial 2\+: MBQC Starter}
\hypertarget{gettingstarted02}{}\label{gettingstarted02}\index{Tutorial 2: MBQC Starter@{Tutorial 2: MBQC Starter}}
...
For the source code of the tutorial, see the file \doxylink{mbqc_starter_8cpp}{examples/mbqc\+Starter.\+cpp}\hypertarget{gettingstarted02_overview}{}\doxysection{\texorpdfstring{Script Overview}{Script Overview}}\label{gettingstarted02_overview}
...
\end{DoxyItemize}\hypertarget{gettingstarted02_usage}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{gettingstarted02_usage}
...
\end{DoxyItemize}\hypertarget{tutorial03_include}{}\doxysubsection{\texorpdfstring{Include Package Header File}{Include Package Header File}}\label{tutorial03_include}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_main}{}\doxysubsection{\texorpdfstring{Set up the Main Function}{Set up the Main Function}}\label{gettingstarted02_main}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_setvalues}{}\doxysubsection{\texorpdfstring{Set Values to Variables}{Set Values to Variables}}\label{gettingstarted02_setvalues}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_printgraph}{}\doxysubsection{\texorpdfstring{Print Graph to File}{Print Graph to File}}\label{gettingstarted02_printgraph}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_loadenv}{}\doxysubsection{\texorpdfstring{Load Qu\+EST Environment}{Load QuEST Environment}}\label{gettingstarted02_loadenv}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_createqreg}{}\doxysubsection{\texorpdfstring{Create Quantum Register}{Create Quantum Register}}\label{gettingstarted02_createqreg}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_initangles}{}\doxysubsection{\texorpdfstring{Initialize Random Angles}{Initialize Random Angles}}\label{gettingstarted02_initangles}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_initstate}{}\doxysubsection{\texorpdfstring{Initialize in Plus State}{Initialize in Plus State}}\label{gettingstarted02_initstate}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_addangles}{}\doxysubsection{\texorpdfstring{Add Angles to Qubits}{Add Angles to Qubits}}\label{gettingstarted02_addangles}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_entangle}{}\doxysubsection{\texorpdfstring{Entangle Graph}{Entangle Graph}}\label{gettingstarted02_entangle}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_measure}{}\doxysubsection{\texorpdfstring{Measure Graph}{Measure Graph}}\label{gettingstarted02_measure}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_printresults}{}\doxysubsection{\texorpdfstring{Print Results to Screen}{Print Results to Screen}}\label{gettingstarted02_printresults}
...
\end{DoxyCode}
\hypertarget{gettingstarted02_unloadenv}{}\doxysubsection{\texorpdfstring{Unload Qu\+EST}{Unload QuEST}}\label{gettingstarted02_unloadenv}
