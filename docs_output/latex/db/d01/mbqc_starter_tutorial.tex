\chapter{Tutorial 1\+: MBQC Starter}
\hypertarget{mbqc_starter_tutorial}{}\label{mbqc_starter_tutorial}\index{Tutorial 1: MBQC Starter@{Tutorial 1: MBQC Starter}}
...
For the source code of the tutorial, see the file \doxylink{mbqc_starter_8cpp}{examples/mbqc\+Starter.\+cpp}\hypertarget{mbqc_starter_tutorial_overview}{}\doxysection{\texorpdfstring{Script Overview}{Script Overview}}\label{mbqc_starter_tutorial_overview}
...
\end{DoxyItemize}\hypertarget{mbqc_starter_tutorial_usage}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{mbqc_starter_tutorial_usage}
...
\end{DoxyItemize}\hypertarget{mbqc_starter_tutorial_include}{}\doxysubsection{\texorpdfstring{Include Package Header File}{Include Package Header File}}\label{mbqc_starter_tutorial_include}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_main}{}\doxysubsection{\texorpdfstring{Set up the Main Function}{Set up the Main Function}}\label{mbqc_starter_tutorial_main}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_setvalues}{}\doxysubsection{\texorpdfstring{Set Values to Variables}{Set Values to Variables}}\label{mbqc_starter_tutorial_setvalues}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_printgraph}{}\doxysubsection{\texorpdfstring{Print Graph to File}{Print Graph to File}}\label{mbqc_starter_tutorial_printgraph}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_loadenv}{}\doxysubsection{\texorpdfstring{Load Qu\+EST Environment}{Load QuEST Environment}}\label{mbqc_starter_tutorial_loadenv}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_createqreg}{}\doxysubsection{\texorpdfstring{Create Quantum Register}{Create Quantum Register}}\label{mbqc_starter_tutorial_createqreg}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_initangles}{}\doxysubsection{\texorpdfstring{Initialize Random Angles}{Initialize Random Angles}}\label{mbqc_starter_tutorial_initangles}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_initstate}{}\doxysubsection{\texorpdfstring{Initialize in Plus State}{Initialize in Plus State}}\label{mbqc_starter_tutorial_initstate}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_addangles}{}\doxysubsection{\texorpdfstring{Add Angles to Qubits}{Add Angles to Qubits}}\label{mbqc_starter_tutorial_addangles}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_entangle}{}\doxysubsection{\texorpdfstring{Entangle Graph}{Entangle Graph}}\label{mbqc_starter_tutorial_entangle}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_measure}{}\doxysubsection{\texorpdfstring{Measure Graph}{Measure Graph}}\label{mbqc_starter_tutorial_measure}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_printresults}{}\doxysubsection{\texorpdfstring{Print Results to Screen}{Print Results to Screen}}\label{mbqc_starter_tutorial_printresults}
...
\end{DoxyCode}
\hypertarget{mbqc_starter_tutorial_unloadenv}{}\doxysubsection{\texorpdfstring{Unload Qu\+EST}{Unload QuEST}}\label{mbqc_starter_tutorial_unloadenv}
